M:led
F:G$init_led$0$0({3}DF,SV:S),Z,0,0,0,0,0
F:G$set_led$0$0({3}DF,SV:S),Z,0,0,0,0,0
F:G$handle_led$0$0({3}DF,SC:S),Z,0,0,0,0,0
T:Fled$uip_udp_conn[]
T:Fled$psock[({0}S:S$pt$0$0({2}STpt:S),Z,0,0)({2}S:S$psockpt$0$0({2}STpt:S),Z,0,0)({4}S:S$sendptr$0$0({3}DG,SC:U),Z,0,0)({7}S:S$readptr$0$0({3}DG,SC:U),Z,0,0)({10}S:S$bufptr$0$0({3}DG,SC:S),Z,0,0)({13}S:S$sendlen$0$0({2}SI:U),Z,0,0)({15}S:S$readlen$0$0({2}SI:U),Z,0,0)({17}S:S$buf$0$0({5}STpsock_buf:S),Z,0,0)({22}S:S$bufsize$0$0({2}SI:U),Z,0,0)({24}S:S$state$0$0({1}SC:U),Z,0,0)]
T:Fled$sys_config[]
T:Fled$led[({0}S:S$pt$0$0({2}STpt:S),Z,0,0)({2}S:S$command$0$0({1}SC:U),Z,0,0)({3}S:S$blink_rate$0$0({1}SC:U),Z,0,0)({4}S:S$timer$0$0({1}SC:U),Z,0,0)]
T:Fled$__00020000[({0}S:S$drop$1$0({2}SI:U),Z,0,0)({2}S:S$recv$1$0({2}SI:U),Z,0,0)({4}S:S$sent$1$0({2}SI:U),Z,0,0)({6}S:S$vhlerr$1$0({2}SI:U),Z,0,0)({8}S:S$hblenerr$1$0({2}SI:U),Z,0,0)({10}S:S$lblenerr$1$0({2}SI:U),Z,0,0)({12}S:S$fragerr$1$0({2}SI:U),Z,0,0)({14}S:S$chkerr$1$0({2}SI:U),Z,0,0)({16}S:S$protoerr$1$0({2}SI:U),Z,0,0)]
T:Fled$__00020001[({0}S:S$drop$1$0({2}SI:U),Z,0,0)({2}S:S$recv$1$0({2}SI:U),Z,0,0)({4}S:S$sent$1$0({2}SI:U),Z,0,0)({6}S:S$typeerr$1$0({2}SI:U),Z,0,0)]
T:Fled$__00020002[({0}S:S$drop$1$0({2}SI:U),Z,0,0)({2}S:S$recv$1$0({2}SI:U),Z,0,0)({4}S:S$sent$1$0({2}SI:U),Z,0,0)({6}S:S$chkerr$1$0({2}SI:U),Z,0,0)({8}S:S$ackerr$1$0({2}SI:U),Z,0,0)({10}S:S$rst$1$0({2}SI:U),Z,0,0)({12}S:S$rexmit$1$0({2}SI:U),Z,0,0)({14}S:S$syndrop$1$0({2}SI:U),Z,0,0)({16}S:S$synrst$1$0({2}SI:U),Z,0,0)]
T:Fled$uip_conn[({0}S:S$ripaddr$0$0({4}DA2,SI:U),Z,0,0)({4}S:S$lport$0$0({2}SI:U),Z,0,0)({6}S:S$rport$0$0({2}SI:U),Z,0,0)({8}S:S$rcv_nxt$0$0({4}DA4,SC:U),Z,0,0)({12}S:S$snd_nxt$0$0({4}DA4,SC:U),Z,0,0)({16}S:S$len$0$0({2}SI:U),Z,0,0)({18}S:S$mss$0$0({2}SI:U),Z,0,0)({20}S:S$initialmss$0$0({2}SI:U),Z,0,0)({22}S:S$sa$0$0({1}SC:U),Z,0,0)({23}S:S$sv$0$0({1}SC:U),Z,0,0)({24}S:S$rto$0$0({1}SC:U),Z,0,0)({25}S:S$tcpstateflags$0$0({1}SC:U),Z,0,0)({26}S:S$timer$0$0({1}SC:U),Z,0,0)({27}S:S$nrtx$0$0({1}SC:U),Z,0,0)({28}S:S$appstate$0$0({268}SThttpd_state:S),Z,0,0)]
T:Fled$httpd_fs_file[({0}S:S$fsdata$0$0({3}DG,SC:S),Z,0,0)({3}S:S$len$0$0({2}SI:S),Z,0,0)]
T:Fled$uip_tcpip_hdr[({0}S:S$vhl$0$0({1}SC:U),Z,0,0)({1}S:S$tos$0$0({1}SC:U),Z,0,0)({2}S:S$len$0$0({2}DA2,SC:U),Z,0,0)({4}S:S$ipid$0$0({2}DA2,SC:U),Z,0,0)({6}S:S$ipoffset$0$0({2}DA2,SC:U),Z,0,0)({8}S:S$ttl$0$0({1}SC:U),Z,0,0)({9}S:S$proto$0$0({1}SC:U),Z,0,0)({10}S:S$ipchksum$0$0({2}SI:U),Z,0,0)({12}S:S$srcipaddr$0$0({4}DA2,SI:U),Z,0,0)({16}S:S$destipaddr$0$0({4}DA2,SI:U),Z,0,0)({20}S:S$srcport$0$0({2}SI:U),Z,0,0)({22}S:S$destport$0$0({2}SI:U),Z,0,0)({24}S:S$seqno$0$0({4}DA4,SC:U),Z,0,0)({28}S:S$ackno$0$0({4}DA4,SC:U),Z,0,0)({32}S:S$tcpoffset$0$0({1}SC:U),Z,0,0)({33}S:S$flags$0$0({1}SC:U),Z,0,0)({34}S:S$wnd$0$0({2}DA2,SC:U),Z,0,0)({36}S:S$tcpchksum$0$0({2}SI:U),Z,0,0)({38}S:S$urgp$0$0({2}DA2,SC:U),Z,0,0)({40}S:S$optdata$0$0({4}DA4,SC:U),Z,0,0)]
T:Fled$uip_udpip_hdr[({0}S:S$vhl$0$0({1}SC:U),Z,0,0)({1}S:S$tos$0$0({1}SC:U),Z,0,0)({2}S:S$len$0$0({2}DA2,SC:U),Z,0,0)({4}S:S$ipid$0$0({2}DA2,SC:U),Z,0,0)({6}S:S$ipoffset$0$0({2}DA2,SC:U),Z,0,0)({8}S:S$ttl$0$0({1}SC:U),Z,0,0)({9}S:S$proto$0$0({1}SC:U),Z,0,0)({10}S:S$ipchksum$0$0({2}SI:U),Z,0,0)({12}S:S$srcipaddr$0$0({4}DA2,SI:U),Z,0,0)({16}S:S$destipaddr$0$0({4}DA2,SI:U),Z,0,0)({20}S:S$srcport$0$0({2}SI:U),Z,0,0)({22}S:S$destport$0$0({2}SI:U),Z,0,0)({24}S:S$udplen$0$0({2}SI:U),Z,0,0)({26}S:S$udpchksum$0$0({2}SI:U),Z,0,0)]
T:Fled$kicker[({0}S:S$pt$0$0({2}STpt:S),Z,0,0)]
T:Fled$uip_eth_hdr[({0}S:S$dest$0$0({6}STuip_eth_addr:S),Z,0,0)({6}S:S$src$0$0({6}STuip_eth_addr:S),Z,0,0)({12}S:S$type$0$0({2}SI:U),Z,0,0)]
...
T:Fled$psock_buf[({0}S:S$ptr$0$0({3}DG,SC:U),Z,0,0)({3}S:S$left$0$0({2}SI:U),Z,0,0)]
T:Fled$uip_icmpip_hdr[({0}S:S$vhl$0$0({1}SC:U),Z,0,0)({1}S:S$tos$0$0({1}SC:U),Z,0,0)({2}S:S$len$0$0({2}DA2,SC:U),Z,0,0)({4}S:S$ipid$0$0({2}DA2,SC:U),Z,0,0)({6}S:S$ipoffset$0$0({2}DA2,SC:U),Z,0,0)({8}S:S$ttl$0$0({1}SC:U),Z,0,0)({9}S:S$proto$0$0({1}SC:U),Z,0,0)({10}S:S$ipchksum$0$0({2}SI:U),Z,0,0)({12}S:S$srcipaddr$0$0({4}DA2,SI:U),Z,0,0)({16}S:S$destipaddr$0$0({4}DA2,SI:U),Z,0,0)({20}S:S$type$0$0({1}SC:U),Z,0,0)({21}S:S$icode$0$0({1}SC:U),Z,0,0)({22}S:S$icmpchksum$0$0({2}SI:U),Z,0,0)({24}S:S$id$0$0({2}SI:U),Z,0,0)({26}S:S$seqno$0$0({2}SI:U),Z,0,0)]
T:Fled$uip_stats[({0}S:S$ip$0$0({18}ST__00020000:S),Z,0,0)({18}S:S$icmp$0$0({8}ST__00020001:S),Z,0,0)({26}S:S$tcp$0$0({18}ST__00020002:S),Z,0,0)]
T:Fled$pt[({0}S:S$lc$0$0({2}SI:U),Z,0,0)]
T:Fled$uip_eth_addr[({0}S:S$addr$0$0({6}DA6,SC:U),Z,0,0)]
S:Lhandle_led$sloc0$1$0({3}DG,STled:S),E,0,0
...
S:Lset_led$option$1$1({1}SC:U),F,0,0
S:Lset_led$status$1$1({1}SC:U),F,0,0
S:Lhandle_led$ld$1$1({3}DG,STled:S),F,0,0
S:Lhandle_led$PT_YIELD_FLAG$2$2({1}SC:S),F,0,0
