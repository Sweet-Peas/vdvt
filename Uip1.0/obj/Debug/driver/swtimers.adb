M:swtimers
F:G$init_swtimers$0$0({3}DF,SV:S),Z,0,0,0,0,0
F:G$alloc_timer$0$0({3}DF,SC:S),Z,0,0,0,0,0
F:G$free_timer$0$0({3}DF,SC:U),Z,0,0,0,0,0
F:G$set_timer$0$0({3}DF,SV:S),Z,0,0,0,0,0
F:G$set_timer_cnt$0$0({3}DF,SV:S),Z,0,0,0,0,0
F:G$get_timer$0$0({3}DF,SL:U),Z,0,0,0,0,0
F:G$get_timer_status$0$0({3}DF,SC:U),Z,0,0,0,0,0
F:G$stop_timer$0$0({3}DF,SV:S),Z,0,0,0,0,0
F:G$start_timer$0$0({3}DF,SV:S),Z,0,0,0,0,0
F:G$handle_kicker$0$0({3}DF,SC:S),Z,0,0,0,0,0
T:Fswtimers$uip_udp_conn[]
T:Fswtimers$psock[({0}S:S$pt$0$0({2}STpt:S),Z,0,0)({2}S:S$psockpt$0$0({2}STpt:S),Z,0,0)({4}S:S$sendptr$0$0({3}DG,SC:U),Z,0,0)({7}S:S$readptr$0$0({3}DG,SC:U),Z,0,0)({10}S:S$bufptr$0$0({3}DG,SC:S),Z,0,0)({13}S:S$sendlen$0$0({2}SI:U),Z,0,0)({15}S:S$readlen$0$0({2}SI:U),Z,0,0)({17}S:S$buf$0$0({5}STpsock_buf:S),Z,0,0)({22}S:S$bufsize$0$0({2}SI:U),Z,0,0)({24}S:S$state$0$0({1}SC:U),Z,0,0)]
T:Fswtimers$sys_config[]
T:Fswtimers$__00020000[({0}S:S$drop$1$0({2}SI:U),Z,0,0)({2}S:S$recv$1$0({2}SI:U),Z,0,0)({4}S:S$sent$1$0({2}SI:U),Z,0,0)({6}S:S$vhlerr$1$0({2}SI:U),Z,0,0)({8}S:S$hblenerr$1$0({2}SI:U),Z,0,0)({10}S:S$lblenerr$1$0({2}SI:U),Z,0,0)({12}S:S$fragerr$1$0({2}SI:U),Z,0,0)({14}S:S$chkerr$1$0({2}SI:U),Z,0,0)({16}S:S$protoerr$1$0({2}SI:U),Z,0,0)]
T:Fswtimers$__00020001[({0}S:S$drop$1$0({2}SI:U),Z,0,0)({2}S:S$recv$1$0({2}SI:U),Z,0,0)({4}S:S$sent$1$0({2}SI:U),Z,0,0)({6}S:S$typeerr$1$0({2}SI:U),Z,0,0)]
T:Fswtimers$__00020002[({0}S:S$drop$1$0({2}SI:U),Z,0,0)({2}S:S$recv$1$0({2}SI:U),Z,0,0)({4}S:S$sent$1$0({2}SI:U),Z,0,0)({6}S:S$chkerr$1$0({2}SI:U),Z,0,0)({8}S:S$ackerr$1$0({2}SI:U),Z,0,0)({10}S:S$rst$1$0({2}SI:U),Z,0,0)({12}S:S$rexmit$1$0({2}SI:U),Z,0,0)({14}S:S$syndrop$1$0({2}SI:U),Z,0,0)({16}S:S$synrst$1$0({2}SI:U),Z,0,0)]
T:Fswtimers$uip_conn[({0}S:S$ripaddr$0$0({4}DA2,SI:U),Z,0,0)({4}S:S$lport$0$0({2}SI:U),Z,0,0)({6}S:S$rport$0$0({2}SI:U),Z,0,0)({8}S:S$rcv_nxt$0$0({4}DA4,SC:U),Z,0,0)({12}S:S$snd_nxt$0$0({4}DA4,SC:U),Z,0,0)({16}S:S$len$0$0({2}SI:U),Z,0,0)({18}S:S$mss$0$0({2}SI:U),Z,0,0)({20}S:S$initialmss$0$0({2}SI:U),Z,0,0)({22}S:S$sa$0$0({1}SC:U),Z,0,0)({23}S:S$sv$0$0({1}SC:U),Z,0,0)({24}S:S$rto$0$0({1}SC:U),Z,0,0)({25}S:S$tcpstateflags$0$0({1}SC:U),Z,0,0)({26}S:S$timer$0$0({1}SC:U),Z,0,0)({27}S:S$nrtx$0$0({1}SC:U),Z,0,0)({28}S:S$appstate$0$0({268}SThttpd_state:S),Z,0,0)]
T:Fswtimers$httpd_fs_file[({0}S:S$fsdata$0$0({3}DG,SC:S),Z,0,0)({3}S:S$len$0$0({2}SI:S),Z,0,0)]
T:Fswtimers$uip_tcpip_hdr[({0}S:S$vhl$0$0({1}SC:U),Z,0,0)({1}S:S$tos$0$0({1}SC:U),Z,0,0)({2}S:S$len$0$0({2}DA2,SC:U),Z,0,0)({4}S:S$ipid$0$0({2}DA2,SC:U),Z,0,0)({6}S:S$ipoffset$0$0({2}DA2,SC:U),Z,0,0)({8}S:S$ttl$0$0({1}SC:U),Z,0,0)({9}S:S$proto$0$0({1}SC:U),Z,0,0)({10}S:S$ipchksum$0$0({2}SI:U),Z,0,0)({12}S:S$srcipaddr$0$0({4}DA2,SI:U),Z,0,0)({16}S:S$destipaddr$0$0({4}DA2,SI:U),Z,0,0)({20}S:S$srcport$0$0({2}SI:U),Z,0,0)({22}S:S$destport$0$0({2}SI:U),Z,0,0)({24}S:S$seqno$0$0({4}DA4,SC:U),Z,0,0)({28}S:S$ackno$0$0({4}DA4,SC:U),Z,0,0)({32}S:S$tcpoffset$0$0({1}SC:U),Z,0,0)({33}S:S$flags$0$0({1}SC:U),Z,0,0)({34}S:S$wnd$0$0({2}DA2,SC:U),Z,0,0)({36}S:S$tcpchksum$0$0({2}SI:U),Z,0,0)({38}S:S$urgp$0$0({2}DA2,SC:U),Z,0,0)({40}S:S$optdata$0$0({4}DA4,SC:U),Z,0,0)]
T:Fswtimers$uip_udpip_hdr[({0}S:S$vhl$0$0({1}SC:U),Z,0,0)({1}S:S$tos$0$0({1}SC:U),Z,0,0)({2}S:S$len$0$0({2}DA2,SC:U),Z,0,0)({4}S:S$ipid$0$0({2}DA2,SC:U),Z,0,0)({6}S:S$ipoffset$0$0({2}DA2,SC:U),Z,0,0)({8}S:S$ttl$0$0({1}SC:U),Z,0,0)({9}S:S$proto$0$0({1}SC:U),Z,0,0)({10}S:S$ipchksum$0$0({2}SI:U),Z,0,0)({12}S:S$srcipaddr$0$0({4}DA2,SI:U),Z,0,0)({16}S:S$destipaddr$0$0({4}DA2,SI:U),Z,0,0)({20}S:S$srcport$0$0({2}SI:U),Z,0,0)({22}S:S$destport$0$0({2}SI:U),Z,0,0)({24}S:S$udplen$0$0({2}SI:U),Z,0,0)({26}S:S$udpchksum$0$0({2}SI:U),Z,0,0)]
T:Fswtimers$kicker[({0}S:S$pt$0$0({2}STpt:S),Z,0,0)]
T:Fswtimers$uip_eth_hdr[({0}S:S$dest$0$0({6}STuip_eth_addr:S),Z,0,0)({6}S:S$src$0$0({6}STuip_eth_addr:S),Z,0,0)({12}S:S$type$0$0({2}SI:U),Z,0,0)]
T:Fswtimers$httpd_state[({0}S:S$timer$0$0({1}SC:U),Z,0,0)({1}S:S$sin$0$0({25}STpsock:S),Z,0,0)({26}S:S$sout$0$0({25}STpsock:S),Z,0,0)({51}S:S$outputpt$0$0({2}STpt:S),Z,0,0)({53}S:S$scriptpt$0$0({2}STpt:S),Z,0,0)({55}S:S$inputbuf$0$0({175}DA175,SC:S),Z,0,0)({230}S:S$filename$0$0({20}DA20,SC:S),Z,0,0)({250}S:S$state$0$0({1}SC:S),Z,0,0)({251}S:S$file$0$0({5}SThttpd_fs_file:S),Z,0,0)({256}S:S$len$0$0({2}SI:S),Z,0,0)({258}S:S$scriptptr$0$0({3}DG,SC:S),Z,0,0)({261}S:S$scriptlen$0$0({2}SI:S),Z,0,0)({263}S:S$count$0$0({2}SI:U),Z,0,0)({265}S:S$content_length$0$0({2}SI:U),Z,0,0)({267}S:S$is_authorized$0$0({1}SC:U),Z,0,0)]
T:Fswtimers$psock_buf[({0}S:S$ptr$0$0({3}DG,SC:U),Z,0,0)({3}S:S$left$0$0({2}SI:U),Z,0,0)]
T:Fswtimers$uip_icmpip_hdr[({0}S:S$vhl$0$0({1}SC:U),Z,0,0)({1}S:S$tos$0$0({1}SC:U),Z,0,0)({2}S:S$len$0$0({2}DA2,SC:U),Z,0,0)({4}S:S$ipid$0$0({2}DA2,SC:U),Z,0,0)({6}S:S$ipoffset$0$0({2}DA2,SC:U),Z,0,0)({8}S:S$ttl$0$0({1}SC:U),Z,0,0)({9}S:S$proto$0$0({1}SC:U),Z,0,0)({10}S:S$ipchksum$0$0({2}SI:U),Z,0,0)({12}S:S$srcipaddr$0$0({4}DA2,SI:U),Z,0,0)({16}S:S$destipaddr$0$0({4}DA2,SI:U),Z,0,0)({20}S:S$type$0$0({1}SC:U),Z,0,0)({21}S:S$icode$0$0({1}SC:U),Z,0,0)({22}S:S$icmpchksum$0$0({2}SI:U),Z,0,0)({24}S:S$id$0$0({2}SI:U),Z,0,0)({26}S:S$seqno$0$0({2}SI:U),Z,0,0)]
T:Fswtimers$uip_stats[({0}S:S$ip$0$0({18}ST__00020000:S),Z,0,0)({18}S:S$icmp$0$0({8}ST__00020001:S),Z,0,0)({26}S:S$tcp$0$0({18}ST__00020002:S),Z,0,0)]
T:Fswtimers$pt[({0}S:S$lc$0$0({2}SI:U),Z,0,0)]
T:Fswtimers$uip_eth_addr[({0}S:S$addr$0$0({6}DA6,SC:U),Z,0,0)]
S:Lhandle_kicker$i$5$7({1}SC:U),R,0,0,[r5]
...
S:Linit_swtimers$i$1$1({1}SC:U),F,0,0
S:Lalloc_timer$i$1$1({1}SC:U),F,0,0
S:Lfree_timer$timer$1$1({1}SC:U),F,0,0
S:Lset_timer$time$1$1({4}SL:U),F,0,0
S:Lset_timer$cb$1$1({2}DC,DF,SV:S),F,0,0
S:Lset_timer$timer$1$1({1}SC:U),F,0,0
S:Lset_timer_cnt$time$1$1({4}SL:U),F,0,0
S:Lset_timer_cnt$timer$1$1({1}SC:U),F,0,0
S:Lget_timer$timer$1$1({1}SC:U),F,0,0
S:Lget_timer$value$1$1({4}SL:U),F,0,0
S:Lget_timer_status$timer$1$1({1}SC:U),F,0,0
S:Lstop_timer$timer$1$1({1}SC:U),F,0,0
S:Lstart_timer$timer$1$1({1}SC:U),F,0,0
S:Lhandle_kicker$Kicker$1$1({3}DG,STkicker:S),F,0,0
S:Lhandle_kicker$PT_YIELD_FLAG$2$2({1}SC:S),F,0,0
S:Fswtimers$count$0$0({1}SC:U),F,0,0
...
S:Fswtimers$__xinit_count$0$0({1}SC:U),C,0,0
