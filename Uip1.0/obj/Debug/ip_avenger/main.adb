...
F:G$smtp_done$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$cleanup$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Timer0_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$get_timebase$0$0({2}DF,SL:U),Z,0,0,0,0,0
F:G$Timer0_ISR$0$0({2}DF,SV:S),Z,0,0,1,1,1
T:Fmain$uip_udp_conn[]
T:Fmain$psock[({0}S:S$pt$0$0({2}STpt:S),Z,0,0)({2}S:S$psockpt$0$0({2}STpt:S),Z,0,0)({4}S:S$sendptr$0$0({3}DG,SC:U),Z,0,0)({7}S:S$readptr$0$0({3}DG,SC:U),Z,0,0)({10}S:S$bufptr$0$0({3}DG,SC:S),Z,0,0)({13}S:S$sendlen$0$0({2}SI:U),Z,0,0)({15}S:S$readlen$0$0({2}SI:U),Z,0,0)({17}S:S$buf$0$0({5}STpsock_buf:S),Z,0,0)({22}S:S$bufsize$0$0({2}SI:U),Z,0,0)({24}S:S$state$0$0({1}SC:U),Z,0,0)]
T:Fmain$adc[({0}S:S$last_sample$0$0({2}SI:U),Z,0,0)({2}S:S$latest_average$0$0({2}SI:U),Z,0,0)({4}S:S$channel$0$0({1}SC:U),Z,0,0)({5}S:S$values$0$0({64}DA32,SI:U),Z,0,0)({69}S:S$r_ptr$0$0({1}SC:U),Z,0,0)({70}S:S$w_ptr$0$0({1}SC:U),Z,0,0)({71}S:S$n$0$0({1}SC:U),Z,0,0)]
T:Fmain$sys_config[({0}S:S$mac_addr$0$0({6}STuip_eth_addr:S),Z,0,0)({6}S:S$ip_addr$0$0({4}DA4,SC:U),Z,0,0)({10}S:S$netmask$0$0({4}DA4,SC:U),Z,0,0)({14}S:S$gw_addr$0$0({4}DA4,SC:U),Z,0,0)({18}S:S$http_port$0$0({2}SI:U),Z,0,0)({20}S:S$smtp_ip_addr$0$0({4}DA4,SC:U),Z,0,0)({24}S:S$smtp_port$0$0({2}SI:U),Z,0,0)({26}S:S$node_name$0$0({12}DA12,SC:U),Z,0,0)({38}S:S$email_to_address$0$0({30}DA30,SC:S),Z,0,0)({68}S:S$heater$0$0({1}SC:U),Z,0,0)({69}S:S$heater_limit_temp$0$0({2}SI:S),Z,0,0)({71}S:S$fan$0$0({1}SC:U),Z,0,0)({72}S:S$fan_limit_temp$0$0({2}SI:S),Z,0,0)({74}S:S$heater_mail$0$0({1}SC:U),Z,0,0)({75}S:S$heater_min_temp$0$0({2}SI:S),Z,0,0)({77}S:S$fan_mail$0$0({1}SC:U),Z,0,0)({78}S:S$fan_max_temp$0$0({2}SI:S),Z,0,0)({80}S:S$elcost$0$0({2}SI:S),Z,0,0)({82}S:S$threshold$0$0({2}SI:S),Z,0,0)({84}S:S$username$0$0({30}DA30,SC:S),Z,0,0)({114}S:S$password$0$0({10}DA10,SC:S),Z,0,0)({124}S:S$authenabled$0$0({1}SC:S),Z,0,0)]
T:Fmain$led[({0}S:S$pt$0$0({2}STpt:S),Z,0,0)({2}S:S$command$0$0({1}SC:U),Z,0,0)({3}S:S$blink_rate$0$0({1}SC:U),Z,0,0)({4}S:S$timer$0$0({1}SC:U),Z,0,0)]
T:Fmain$fan[({0}S:S$pt$0$0({2}STpt:S),Z,0,0)({2}S:S$fa$0$0({3}DG,STpt_alarm:S),Z,0,0)({5}S:S$t1$0$0({2}SI:S),Z,0,0)({7}S:S$t2$0$0({2}SI:S),Z,0,0)({9}S:S$temp$0$0({2}SI:S),Z,0,0)({11}S:S$sensor$0$0({1}SC:U),Z,0,0)({12}S:S$timer$0$0({1}SC:U),Z,0,0)({13}S:S$state$0$0({1}SC:U),Z,0,0)({14}S:S$pwrtime$0$0({8}STpower_timer:S),Z,0,0)]
T:Fmain$__00020000[({0}S:S$drop$1$0({2}SI:U),Z,0,0)({2}S:S$recv$1$0({2}SI:U),Z,0,0)({4}S:S$sent$1$0({2}SI:U),Z,0,0)({6}S:S$vhlerr$1$0({2}SI:U),Z,0,0)({8}S:S$hblenerr$1$0({2}SI:U),Z,0,0)({10}S:S$lblenerr$1$0({2}SI:U),Z,0,0)({12}S:S$fragerr$1$0({2}SI:U),Z,0,0)({14}S:S$chkerr$1$0({2}SI:U),Z,0,0)({16}S:S$protoerr$1$0({2}SI:U),Z,0,0)]
T:Fmain$__00020001[({0}S:S$drop$1$0({2}SI:U),Z,0,0)({2}S:S$recv$1$0({2}SI:U),Z,0,0)({4}S:S$sent$1$0({2}SI:U),Z,0,0)({6}S:S$typeerr$1$0({2}SI:U),Z,0,0)]
T:Fmain$__00020002[({0}S:S$drop$1$0({2}SI:U),Z,0,0)({2}S:S$recv$1$0({2}SI:U),Z,0,0)({4}S:S$sent$1$0({2}SI:U),Z,0,0)({6}S:S$chkerr$1$0({2}SI:U),Z,0,0)({8}S:S$ackerr$1$0({2}SI:U),Z,0,0)({10}S:S$rst$1$0({2}SI:U),Z,0,0)({12}S:S$rexmit$1$0({2}SI:U),Z,0,0)({14}S:S$syndrop$1$0({2}SI:U),Z,0,0)({16}S:S$synrst$1$0({2}SI:U),Z,0,0)]
T:Fmain$pt_alarm[({0}S:S$pt$0$0({2}STpt:S),Z,0,0)({2}S:S$timer$0$0({1}SC:S),Z,0,0)({3}S:S$t1$0$0({2}SI:S),Z,0,0)({5}S:S$t2$0$0({2}SI:S),Z,0,0)({7}S:S$sensor$0$0({1}SC:U),Z,0,0)({8}S:S$n$0$0({1}SC:U),Z,0,0)]
T:Fmain$uip_conn[({0}S:S$ripaddr$0$0({4}DA2,SI:U),Z,0,0)({4}S:S$lport$0$0({2}SI:U),Z,0,0)({6}S:S$rport$0$0({2}SI:U),Z,0,0)({8}S:S$rcv_nxt$0$0({4}DA4,SC:U),Z,0,0)({12}S:S$snd_nxt$0$0({4}DA4,SC:U),Z,0,0)({16}S:S$len$0$0({2}SI:U),Z,0,0)({18}S:S$mss$0$0({2}SI:U),Z,0,0)({20}S:S$initialmss$0$0({2}SI:U),Z,0,0)({22}S:S$sa$0$0({1}SC:U),Z,0,0)({23}S:S$sv$0$0({1}SC:U),Z,0,0)({24}S:S$rto$0$0({1}SC:U),Z,0,0)({25}S:S$tcpstateflags$0$0({1}SC:U),Z,0,0)({26}S:S$timer$0$0({1}SC:U),Z,0,0)({27}S:S$nrtx$0$0({1}SC:U),Z,0,0)({28}S:S$appstate$0$0({268}SThttpd_state:S),Z,0,0)]
T:Fmain$httpd_fs_file[({0}S:S$fsdata$0$0({3}DG,SC:S),Z,0,0)({3}S:S$len$0$0({2}SI:S),Z,0,0)]
T:Fmain$uip_tcpip_hdr[({0}S:S$vhl$0$0({1}SC:U),Z,0,0)({1}S:S$tos$0$0({1}SC:U),Z,0,0)({2}S:S$len$0$0({2}DA2,SC:U),Z,0,0)({4}S:S$ipid$0$0({2}DA2,SC:U),Z,0,0)({6}S:S$ipoffset$0$0({2}DA2,SC:U),Z,0,0)({8}S:S$ttl$0$0({1}SC:U),Z,0,0)({9}S:S$proto$0$0({1}SC:U),Z,0,0)({10}S:S$ipchksum$0$0({2}SI:U),Z,0,0)({12}S:S$srcipaddr$0$0({4}DA2,SI:U),Z,0,0)({16}S:S$destipaddr$0$0({4}DA2,SI:U),Z,0,0)({20}S:S$srcport$0$0({2}SI:U),Z,0,0)({22}S:S$destport$0$0({2}SI:U),Z,0,0)({24}S:S$seqno$0$0({4}DA4,SC:U),Z,0,0)({28}S:S$ackno$0$0({4}DA4,SC:U),Z,0,0)({32}S:S$tcpoffset$0$0({1}SC:U),Z,0,0)({33}S:S$flags$0$0({1}SC:U),Z,0,0)({34}S:S$wnd$0$0({2}DA2,SC:U),Z,0,0)({36}S:S$tcpchksum$0$0({2}SI:U),Z,0,0)({38}S:S$urgp$0$0({2}DA2,SC:U),Z,0,0)({40}S:S$optdata$0$0({4}DA4,SC:U),Z,0,0)]
T:Fmain$uip_udpip_hdr[({0}S:S$vhl$0$0({1}SC:U),Z,0,0)({1}S:S$tos$0$0({1}SC:U),Z,0,0)({2}S:S$len$0$0({2}DA2,SC:U),Z,0,0)({4}S:S$ipid$0$0({2}DA2,SC:U),Z,0,0)({6}S:S$ipoffset$0$0({2}DA2,SC:U),Z,0,0)({8}S:S$ttl$0$0({1}SC:U),Z,0,0)({9}S:S$proto$0$0({1}SC:U),Z,0,0)({10}S:S$ipchksum$0$0({2}SI:U),Z,0,0)({12}S:S$srcipaddr$0$0({4}DA2,SI:U),Z,0,0)({16}S:S$destipaddr$0$0({4}DA2,SI:U),Z,0,0)({20}S:S$srcport$0$0({2}SI:U),Z,0,0)({22}S:S$destport$0$0({2}SI:U),Z,0,0)({24}S:S$udplen$0$0({2}SI:U),Z,0,0)({26}S:S$udpchksum$0$0({2}SI:U),Z,0,0)]
T:Fmain$kicker[({0}S:S$pt$0$0({2}STpt:S),Z,0,0)]
T:Fmain$uip_eth_hdr[({0}S:S$dest$0$0({6}STuip_eth_addr:S),Z,0,0)({6}S:S$src$0$0({6}STuip_eth_addr:S),Z,0,0)({12}S:S$type$0$0({2}SI:U),Z,0,0)]
T:Fmain$adcd[({0}S:S$pt$0$0({2}STpt:S),Z,0,0)({2}S:S$ha$0$0({3}DG,STpt_alarm:S),Z,0,0)({5}S:S$t1$0$0({2}SI:S),Z,0,0)({7}S:S$t2$0$0({2}SI:S),Z,0,0)({9}S:S$temp$0$0({2}SI:S),Z,0,0)({11}S:S$sensor$0$0({1}SC:U),Z,0,0)({12}S:S$timer$0$0({1}SC:U),Z,0,0)({13}S:S$state$0$0({1}SC:U),Z,0,0)({14}S:S$pwrtime$0$0({8}STpower_timer:S),Z,0,0)]
T:Fmain$httpd_state[({0}S:S$timer$0$0({1}SC:U),Z,0,0)({1}S:S$sin$0$0({25}STpsock:S),Z,0,0)({26}S:S$sout$0$0({25}STpsock:S),Z,0,0)({51}S:S$outputpt$0$0({2}STpt:S),Z,0,0)({53}S:S$scriptpt$0$0({2}STpt:S),Z,0,0)({55}S:S$inputbuf$0$0({175}DA175,SC:S),Z,0,0)({230}S:S$filename$0$0({20}DA20,SC:S),Z,0,0)({250}S:S$state$0$0({1}SC:S),Z,0,0)({251}S:S$file$0$0({5}SThttpd_fs_file:S),Z,0,0)({256}S:S$len$0$0({2}SI:S),Z,0,0)({258}S:S$scriptptr$0$0({3}DG,SC:S),Z,0,0)({261}S:S$scriptlen$0$0({2}SI:S),Z,0,0)({263}S:S$count$0$0({2}SI:U),Z,0,0)({265}S:S$content_length$0$0({2}SI:U),Z,0,0)({267}S:S$is_authorized$0$0({1}SC:U),Z,0,0)]
T:Fmain$power_timer[({0}S:S$ref_time$0$0({4}SL:U),Z,0,0)({4}S:S$time_on$0$0({4}SL:U),Z,0,0)]
T:Fmain$psock_buf[({0}S:S$ptr$0$0({3}DG,SC:U),Z,0,0)({3}S:S$left$0$0({2}SI:U),Z,0,0)]
T:Fmain$uip_icmpip_hdr[({0}S:S$vhl$0$0({1}SC:U),Z,0,0)({1}S:S$tos$0$0({1}SC:U),Z,0,0)({2}S:S$len$0$0({2}DA2,SC:U),Z,0,0)({4}S:S$ipid$0$0({2}DA2,SC:U),Z,0,0)({6}S:S$ipoffset$0$0({2}DA2,SC:U),Z,0,0)({8}S:S$ttl$0$0({1}SC:U),Z,0,0)({9}S:S$proto$0$0({1}SC:U),Z,0,0)({10}S:S$ipchksum$0$0({2}SI:U),Z,0,0)({12}S:S$srcipaddr$0$0({4}DA2,SI:U),Z,0,0)({16}S:S$destipaddr$0$0({4}DA2,SI:U),Z,0,0)({20}S:S$type$0$0({1}SC:U),Z,0,0)({21}S:S$icode$0$0({1}SC:U),Z,0,0)({22}S:S$icmpchksum$0$0({2}SI:U),Z,0,0)({24}S:S$id$0$0({2}SI:U),Z,0,0)({26}S:S$seqno$0$0({2}SI:U),Z,0,0)]
T:Fmain$uip_stats[({0}S:S$ip$0$0({18}ST__00020000:S),Z,0,0)({18}S:S$icmp$0$0({8}ST__00020001:S),Z,0,0)({26}S:S$tcp$0$0({18}ST__00020002:S),Z,0,0)]
T:Fmain$pt[({0}S:S$lc$0$0({2}SI:U),Z,0,0)]
T:Fmain$uip_eth_addr[({0}S:S$addr$0$0({6}DA6,SC:U),Z,0,0)]
S:G$uip_ethaddr$0$0({6}STuip_eth_addr:S),G,0,0
S:Fmain$half_Sec$0$0({2}SI:U),G,0,0
S:Fmain$ten_Secs$0$0({2}SI:U),G,0,0
S:Fmain$lled$0$0({1}SC:U),G,0,0
S:Fmain$LedTimer$0$0({2}SI:U),G,0,0
S:Fmain$tmcnt$0$0({1}SC:U),G,0,0
S:Fmain$timebase$0$0({4}SL:U),G,0,0
S:G$SIG_Testmejl$0$0({1}SB0$1:U),H,0,0
S:G$SIG_Sendmejl$0$0({1}SB0$1:U),H,0,0
S:G$callback_kicker$0$0({1}SB0$1:U),H,0,0
S:G$TX_EventPending$0$0({1}SB0$1:U),H,0,0
S:G$ARP_EventPending$0$0({1}SB0$1:U),H,0,0
S:G$LED_EventPending$0$0({1}SB0$1:U),H,0,0
S:G$uartByteAvail$0$0({1}SB0$1:U),H,0,0
S:G$Transmitting$0$0({1}SB0$1:U),H,0,0
S:G$uart_tx_buf_full$0$0({1}SB0$1:U),H,0,0
...
S:G$NIC_REG$0$0({1}SC:U),F,0,0
S:G$NIC_DAT$0$0({1}SC:U),F,0,0
S:G$sys_cfg$0$0({125}STsys_config:S),F,0,0
S:G$kicker$0$0({2}STkicker:S),F,0,0
S:G$swtimer$0$0({40}DA10,SL:U),F,0,0
S:G$timer_table$0$0({10}DA10,SC:U),F,0,0
...
S:G$led$0$0({5}STled:S),F,0,0
S:G$timer_cbs$0$0({20}DA10,DC,DF,SV:S),F,0,0
S:Lmain$i$1$1({2}SI:U),F,0,0
S:Lmain$update$1$1({1}SC:U),F,0,0
S:Lmain$smtp_server$1$1({4}DA2,SI:U),F,0,0
S:Lmain$maild$1$1({2}STpt:S),F,0,0
S:Lsmtp_done$error$1$1({1}SC:U),F,0,0
S:Lget_timebase$temptime$1$1({4}SL:U),F,0,0
...
S:G$write_nicreg$0$0({2}DF,SV:S),C,0,0
S:G$write_nicdata$0$0({2}DF,SV:S),C,0,0
S:G$set_nicreg$0$0({2}DF,SV:S),C,0,0
S:G$read_nicreg$0$0({2}DF,SC:U),C,0,0
S:G$read_nicdata$0$0({2}DF,SC:U),C,0,0
...
S:G$CUart_init$0$0({2}DF,SC:S),C,0,0
S:G$datagram$0$0({2}DF,SV:S),C,0,0
S:G$init_swtimers$0$0({3}DF,SV:S),C,0,0
S:G$set_timer$0$0({3}DF,SV:S),C,0,0
S:G$set_timer_cnt$0$0({3}DF,SV:S),C,0,0
S:G$get_timer$0$0({3}DF,SL:U),C,0,0
S:G$get_timer_status$0$0({3}DF,SC:U),C,0,0
S:G$alloc_timer$0$0({3}DF,SC:S),C,0,0
S:G$free_timer$0$0({3}DF,SC:U),C,0,0
S:G$stop_timer$0$0({3}DF,SV:S),C,0,0
S:G$start_timer$0$0({3}DF,SV:S),C,0,0
S:G$init_kicker$0$0({3}DF,SV:S),C,0,0
S:G$handle_kicker$0$0({3}DF,SC:S),C,0,0
...
S:G$init_led$0$0({3}DF,SV:S),C,0,0
S:G$set_led$0$0({3}DF,SV:S),C,0,0
S:G$handle_led$0$0({3}DF,SC:S),C,0,0
S:G$ADC_ISR$0$0({2}DF,SV:S),C,0,0
S:G$config$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:G$default_cfg$0$0({125}STsys_config:S),D,0,0
S:Fmain$_str_0$0$0({3}DA3,SC:S),D,0,0
S:Fmain$_str_1$0$0({62}DA62,SC:S),D,0,0
S:Fmain$_str_2$0$0({67}DA67,SC:S),D,0,0
S:Fmain$_str_3$0$0({17}DA17,SC:S),D,0,0
S:Fmain$_str_4$0$0({35}DA35,SC:S),D,0,0
S:Fmain$_str_5$0$0({17}DA17,SC:S),D,0,0
S:Fmain$_str_6$0$0({21}DA21,SC:S),D,0,0
S:Fmain$_str_7$0$0({8}DA8,SC:S),D,0,0
S:Fmain$_str_8$0$0({25}DA25,SC:S),D,0,0
S:Fmain$_str_9$0$0({18}DA18,SC:S),D,0,0
S:Fmain$_str_10$0$0({19}DA19,SC:S),D,0,0
S:Fmain$_str_11$0$0({30}DA30,SC:S),D,0,0
